define("CoverwiseGoogleAnalytics/widget/MasterPageTracker", [
    "dojo/_base/declare",
    ...
    return declare("CoverwiseGoogleAnalytics.widget.MasterPageTracker", [_TrackerCore], {
        ...
        _insertGoogleAnalytics: function () {
            ...
            if (typeof window.mxGoogleAnalytics === "undefined") {
                this._replaceTags(this.uaTrackCode, lang.hitch(this, function (text) {
                    ...
                    // added by Coverwise to enable ecommerce
...
require(["CoverwiseGoogleAnalytics/widget/MasterPageTracker"]);
